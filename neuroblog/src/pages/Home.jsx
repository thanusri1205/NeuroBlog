    ...
    <div className="home-bg">
      ...
      <div className="main-content">
        ...
        <div className="content-wrapper">
          {/* Popular Blogs (EMPTY ON PURPOSE) */}
          ...
          <div className="side-features">
            <div className="feature-card">
              ...
              <p>
                A platform where creativity meets ideas. Share your thoughts,
                connect with readers, and grow your influence.
              </p>
            </div>
            <div className="feature-card">
              <h2>Followed Bloggers</h2>
              <p>
                Keep track of the bloggers you follow and never miss their
                latest posts.
              </p>
            </div>
          </div>
